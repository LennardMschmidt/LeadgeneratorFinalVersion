...
export const translations = {
  en: {
    ...
    login: {
      ...
      payAndStartSubscription: 'Pay & Start Subscription',
      selectPlanTitle: 'Select your subscription plan',
      dailyTokens: '{{count}} tokens/day',
      mockPaymentTitle: 'Mock payment details',
      cardNumberPlaceholder: 'Card number (mock)',
    ...
    billingPage: {
      ...
      currentPlan: {
        ...
        scrapeRefillRule: 'Scraping tokens regenerate every day.',
        scrapeRefillAt: 'Next scrape token refill',
        aiTokensTitle: 'AI Evaluation Tokens',
        aiTotal: 'Total This Period',
        aiUsed: 'Used This Period',
        aiRemaining: 'Remaining This Period',
        aiUsageProgress: 'AI Usage Progress',
        aiRefillRule: 'AI tokens refill every month.',
        aiRefillAt: 'Next AI token refill',
      },
      changePlan: {
        title: 'Change Plan',
        description: 'Switch plans instantly. New limits apply immediately.',
        current: 'Current',
        dailyTokens: '{{count}} tokens/day',
    ...
    dashboard: {
      ...
      errors: {
        ...
        linkedinRequiresPro: 'LinkedIn search is available on Pro and Expert plans.',
        upgradeForLinkedIn: 'Upgrade your plan to unlock LinkedIn lead discovery.',
        upgradeForAi: 'Upgrade your plan to unlock AI evaluations.',
      ...
      savedLeads: {
        ...
        noLeadsToSave: 'No visible leads to save.',
        bulkSavedSuccess: 'Saved {{saved}} of {{requested}} lead(s). Skipped: {{skipped}}.',
        bulkSavedError: 'Failed to save visible leads.',
        bulkDeleteLabelAll: 'Delete all leads',
        bulkDeleteLabelStatus: 'Delete all {{status}} leads',
        bulkDeleteLabelTier: 'Delete all {{tier}} leads',
        bulkDeleteLabelStatusTier: 'Delete all {{status}} {{tier}} leads',
        bulkDeleteScopeAll: 'all leads',
        bulkDeleteScopeStatus: 'all {{status}} leads',
        bulkDeleteScopeTier: 'all {{tier}} leads',
        bulkDeleteScopeStatusTier: 'all {{status}} {{tier}} leads',
        bulkDeleteConfirmTitle: 'Delete filtered leads?',
        bulkDeleteConfirmDescription:
          'This will permanently remove {{count}} lead(s) from {{scope}}.',
        bulkDeleteConfirmAction: 'Delete permanently',
        bulkDeleteCancel: 'Cancel',
        bulkDeleting: 'Deleting...',
        bulkDeleteSuccess: 'Deleted {{deleted}} lead(s) from {{scope}}.',
        ...
        aiUpgradeRequired: 'AI evaluations are available on Pro and Expert plans.',
        exportExcel: 'Export Excel',
        loadError: 'Failed to load saved leads.',
        statusUpdated: 'Lead status updated.',
        statusUpdateError: 'Failed to update lead status.',
        deletedSuccess: 'Lead removed.',
        deleteError: 'Failed to remove lead.',
        statusFilterLabel: 'Filter by status',
        searchLabel: 'Search saved leads',
        searchPlaceholder: 'Search business, category, location, source',
        problemFilterLabel: 'Problem Categories',
        problemFilterClear: 'Clear',
        problemFilterEmpty: 'No problem categories found for current filters.',
        searchMatchesOnPage: '{{count}} matching leads on this page',
        loading: 'Loading saved leads...',
        emptyTitle: 'No saved leads yet.',
        emptySubtitle: 'Save leads from the dashboard to manage them here.',
        updatingStatus: 'Updating...',
        remove: 'Remove',
        removing: 'Removing...',
        previousPage: 'Previous',
        nextPage: 'Next',
        paginationSummary: '{{total}} total - Page {{page}} of {{totalPages}}',
        columns: {
          business: 'Business',
          category: 'Category',
          location: 'Location',
        ...
        detailModal: {
          ...
          aiContact: {
            ...
            noWebsiteMode:
              'No website detected for this lead. AI will generate a website-offer opener using business and lead profile data.',
      ...
      websiteAnalysis: {
        ...
        removing: 'Removing analysis...',
        view: 'View Website Analysis',
        saveFirst: 'Save Lead First',
        completed: 'Website analysis completed.',
        removed: 'Website analysis removed.',
        failed: 'Website analysis failed.',
        removeFailed: 'Could not remove website analysis.',
      },
      csv: {
      ...
      searchPanel: {
        ...
        linkedinRequiresPro: 'LinkedIn discovery is available on Pro and Expert plans.',
      ...
      leadTable: {
        ...
        searchPlaceholder: 'Search business, category, location, source, contact',
        problemFilterLabel: 'Problem Categories',
        problemFilterClear: 'Clear',
        problemFilterEmpty: 'Select a Business Type to load problem categories.',
        ...
        saveLeads: 'Save leads',
        savingLeads: 'Saving leads...',
        saveLead: 'Save lead',
        savingLead: 'Saving...',
        savedHint: 'Lead saved successfully.',
        savedHintWithCount: '{{count}} lead(s) saved successfully.',
    ...
    maps: {
      ...
      problemCategories: {
        ...
        'No problem categories available for LinkedIn leads.':
          'No problem categories available for LinkedIn leads.',
  ...
  de: {
    ...
    login: {
      ...
      registerGoogleDisabledForBilling:
        'Bitte registriere dich per E-Mail, damit du einen Tarif wählen und Billing aktivieren kannst.',
      email: 'E-Mail',
      ...
      continueToPlan: 'Weiter zur Tarifauswahl',
      payAndStartSubscription: 'Bezahlen & Abo starten',
      selectPlanTitle: 'Wähle deinen Tarif',
      dailyTokens: '{{count}} Tokens/Tag',
      mockPaymentTitle: 'Mock-Zahlungsdaten',
      cardNumberPlaceholder: 'Kartennummer (Mock)',
      ...
      googleRegisterClicked:
        'Weiterleitung zur Google-Registrierung...',
      emailLoginCaptured:
        'Du bist jetzt als {{email}} eingeloggt.',
      emailRegisterCaptured:
        'Konto erstellt und als {{email}} eingeloggt.',
      registerNeedsConfirmation:
    ...
    billingPage: {
      ...
      currentPlan: {
        ...
        scrapeRefillRule: 'Scraping-Tokens werden jeden Tag neu geladen.',
        scrapeRefillAt: 'Nächstes Scraping-Token-Refill',
        aiTokensTitle: 'AI-Evaluation-Tokens',
        aiTotal: 'Gesamt in diesem Zeitraum',
        aiUsed: 'Verbraucht in diesem Zeitraum',
        aiRemaining: 'Verbleibend in diesem Zeitraum',
        aiUsageProgress: 'AI-Nutzungsfortschritt',
        aiRefillRule: 'AI-Tokens werden monatlich neu geladen.',
        aiRefillAt: 'Nächstes AI-Token-Refill',
      },
      changePlan: {
        title: 'Tarif wechseln',
        description: 'Wechsle sofort den Tarif. Neue Limits gelten direkt.',
        current: 'Aktuell',
        dailyTokens: '{{count}} Tokens/Tag',
    ...
    dashboard: {
      ...
      errors: {
        ...
        linkedinRequiresPro: 'Die LinkedIn-Suche ist im Pro- und Expert-Tarif verfügbar.',
        upgradeForLinkedIn: 'Upgrade deinen Tarif, um LinkedIn-Lead-Discovery freizuschalten.',
        upgradeForAi: 'Upgrade deinen Tarif, um AI-Auswertungen freizuschalten.',
      ...
      savedLeads: {
        ...
        noLeadsToSave: 'Keine sichtbaren Leads zum Speichern.',
        bulkSavedSuccess: '{{saved}} von {{requested}} Lead(s) gespeichert. Übersprungen: {{skipped}}.',
        bulkSavedError: 'Sichtbare Leads konnten nicht gespeichert werden.',
        bulkDeleteLabelAll: 'Alle Leads löschen',
        bulkDeleteLabelStatus: 'Alle {{status}}-Leads löschen',
        bulkDeleteLabelTier: 'Alle {{tier}}-Leads löschen',
        bulkDeleteLabelStatusTier: 'Alle {{status}} {{tier}}-Leads löschen',
        bulkDeleteScopeAll: 'alle Leads',
        bulkDeleteScopeStatus: 'alle {{status}}-Leads',
        bulkDeleteScopeTier: 'alle {{tier}}-Leads',
        bulkDeleteScopeStatusTier: 'alle {{status}} {{tier}}-Leads',
        bulkDeleteConfirmTitle: 'Gefilterte Leads löschen?',
        bulkDeleteConfirmDescription:
          'Diese Aktion entfernt {{count}} Lead(s) aus {{scope}} dauerhaft.',
        bulkDeleteConfirmAction: 'Endgültig löschen',
        bulkDeleteCancel: 'Abbrechen',
        bulkDeleting: 'Lösche...',
        bulkDeleteSuccess: '{{deleted}} Lead(s) aus {{scope}} gelöscht.',
        ...
        aiUpgradeRequired: 'AI-Auswertungen sind im Pro- und Expert-Tarif verfügbar.',
        exportExcel: 'Excel exportieren',
        loadError: 'Gespeicherte Leads konnten nicht geladen werden.',
        statusUpdated: 'Lead-Status wurde aktualisiert.',
        statusUpdateError: 'Lead-Status konnte nicht aktualisiert werden.',
        deletedSuccess: 'Lead wurde entfernt.',
        deleteError: 'Lead konnte nicht entfernt werden.',
        statusFilterLabel: 'Nach Status filtern',
        searchLabel: 'Gespeicherte Leads durchsuchen',
        searchPlaceholder: 'Suche nach Unternehmen, Kategorie, Standort, Quelle',
        problemFilterLabel: 'Problemkategorien',
        problemFilterClear: 'Zurücksetzen',
        problemFilterEmpty: 'Für die aktuellen Filter wurden keine Problemkategorien gefunden.',
        searchMatchesOnPage: '{{count}} passende Leads auf dieser Seite',
        loading: 'Gespeicherte Leads werden geladen...',
        emptyTitle: 'Noch keine gespeicherten Leads.',
        emptySubtitle: 'Speichere Leads im Dashboard, um sie hier zu verwalten.',
        updatingStatus: 'Aktualisiere...',
        remove: 'Entfernen',
        removing: 'Entferne...',
        previousPage: 'Zurück',
        nextPage: 'Weiter',
        paginationSummary: '{{total}} gesamt - Seite {{page}} von {{totalPages}}',
        columns: {
        ...
        detailModal: {
          ...
          aiContact: {
            ...
            noWebsiteMode:
              'Für diesen Lead wurde keine Website erkannt. AI erstellt einen Website-Angebots-Opener auf Basis von Profil- und Lead-Daten.',
      ...
      websiteAnalysis: {
        ...
        removing: 'Analyse wird entfernt...',
        view: 'Website-Analyse anzeigen',
        saveFirst: 'Lead zuerst speichern',
        completed: 'Website-Analyse abgeschlossen.',
        removed: 'Website-Analyse entfernt.',
        failed: 'Website-Analyse fehlgeschlagen.',
        removeFailed: 'Website-Analyse konnte nicht entfernt werden.',
      },
      csv: {
        fileName: 'lead-signal-dashboard-export.csv',
        headers: [
      ...
      searchPanel: {
        ...
        searchSourceGoogle: 'Google',
        searchSourceInstagram: 'Instagram',
        linkedinRequiresPro: 'LinkedIn-Discovery ist nur im Pro- und Expert-Tarif verfügbar.',
      ...
      leadTable: {
        ...
        searchLabel: 'Leads durchsuchen',
        searchPlaceholder: 'Suche nach Unternehmen, Kategorie, Standort, Quelle, Kontakt',
        problemFilterLabel: 'Problemkategorien',
        problemFilterClear: 'Zurücksetzen',
        problemFilterEmpty: 'Wähle zuerst einen Business Type, um Problemkategorien zu laden.',
        ...
        saveLeads: 'Leads speichern',
        savingLeads: 'Speichere Leads...',
        saveLead: 'Lead speichern',
        savingLead: 'Speichere...',
        savedHint: 'Lead erfolgreich gespeichert.',
        savedHintWithCount: '{{count}} Lead(s) erfolgreich gespeichert.',
        openSavedSearches: 'Gespeicherte Suchen öffnen',
    ...
    maps: {
      ...
      problemCategories: {
        ...
        'No problem categories available for LinkedIn leads.':
          'Für LinkedIn-Leads sind keine Problemkategorien verfügbar.',
